...
| **AffineScript** | https://affinescript-lang.org | Type-safe JavaScript compilation for extension logic
...
| `extension/lib/affinescript/` | AffineScript-compiled modules | BrowserAPI (storage wrapper), DatabaseUpdater (weekly refresh), Types (AST)
