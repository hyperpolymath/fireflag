...
* AffineScript compilation warnings (non-blocking)
...
* Fix AffineScript compilation warnings
...
* 🎯 **AffineScript Full Compilation**
** Complete AffineScript type safety
** Compile all UI code
...
3. Fix AffineScript compilation warnings
4. i18n framework
